...
$html = ob_start();
$fechaInicio = !empty($_POST['fecha_inicio_notas_general']) ? $_POST['fecha_inicio_notas_general'] : date("Y-m-d");
$fechaFin = !empty($_POST['fecha_fin_notas_general']) ? $_POST['fecha_fin_notas_general'] : date("Y-m-d");
$bd = new Notas();

$notas = $bd->reporteNotasGeneral($fechaInicio, $fechaFin);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section>
        <h2 class="titulos-section3">Notas surtidas <?php echo $fechaInicio . " - " . $fechaFin ?></h2>
        <table>
            <thead>
                <tr>
                    <th width="10%">FOLIO</th>
                    <th width="10%">NLISTA</th>
                    <th width="10%">SURTIDOR</th>
            ...
            <tbody>
                ...
                if (!empty($notas)) {
                    foreach ($notas as $key => $nota) {
                        ...
                        echo "<td>" . $nota['nlista'] . "</td>";
                        echo "<td>" . $nota['surtidor'] . "</td>";
